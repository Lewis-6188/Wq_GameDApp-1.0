...
public class AlbumGridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(Res.getInstance(mContext).getLayoutID("plugin_camera_select_imageview"),
                    parent, false);
            viewHolder.imageView = (ImageView) convertView.findViewById(Res.getInstance(mContext).getWidgetID("image_view"));
            viewHolder.toggleButton = (ToggleButton) convertView.findViewById(Res.getInstance(mContext).getWidgetID("toggle_button"));
            viewHolder.choosetoggle = (Button) convertView.findViewById(Res.getInstance(mContext).getWidgetID("choosedbt"));
        ...
        if (path.contains("camera_default")) {
            viewHolder.imageView.setImageResource(Res.getInstance(mContext).getDrawableID("plugin_camera_no_pictures"));
        } else {
