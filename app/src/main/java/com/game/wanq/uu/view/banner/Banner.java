...
import com.game.wanq.uu.view.banner.listener.OnBannerClickListener;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.fanl_gray_radius;
    private int mIndicatorUnselectedResId = R.drawable.fanl_white_radius;
    private int mLayoutResId = R.layout.fanl_banner;
    ...
    public Banner setImageLoader(ImageLoaderInterface<View> imageLoader) {
            ...
            if (bannerListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(getContext(), "你正在使用旧版点击事件接口，下标是从1开始，", Toast.LENGTH_SHORT).show();
