...
public class GameFQScrollView extends HorizontalScrollView implements
    ...
    private GanmeFQScrollViewAdapter mAdapter;
    private int mCurrentIndex;//当前最后一张图片的index
    private int mFristIndex;//当前第一张图片的下标

    public GameFQScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onClick(View v) {
        ...
        mOnClickListener.onClickFqGame(v, mViewPos.get(v));
    }
    ...
    public void initDatas(GanmeFQScrollViewAdapter mAdapter, int size) {
...
//        }
    ...
    public interface OnItemClickListener {
        void onClickFqGame(View view, int position);
    }
