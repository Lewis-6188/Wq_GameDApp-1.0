...
public class GameScrollView extends HorizontalScrollView implements
    ...
    public interface OnItemClickListener {
        void onClickGame(View view, int pos);
    }
     ...
     * 数据适配器
     */
    private GanmeScrollViewAdapter mAdapter;
    /**
     * 每屏幕最多显示的个数
     */
...
//			mContainer = (LinearLayout) getChildAt(0);
    ...
    public void notifyCurrentImgChanged() {
        ...
        for (int i = 0; i < mContainer.getChildCount(); i++) {
            mContainer.getChildAt(i).setBackgroundColor(getResources().getColor(R.color.colorPrimarySHse));
        }
     ...
     * @param mAdapter
     */
    public void initDatas(GanmeScrollViewAdapter mAdapter, int mCountOneScreen) {
...
//			Log.e(TAG, getScrollX() + "");
    ...
    public void onClick(View v) {
        if (mOnClickListener != null) {
            ...
            mOnClickListener.onClickGame(v, mViewPos.get(v));
        }
    }
