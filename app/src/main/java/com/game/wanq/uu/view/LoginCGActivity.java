...
public class LoginCGActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (!TextUtils.isEmpty(iconURL))
                        Glide.with(LoginCGActivity.this).load(iconURL).priority(Priority.HIGH).into(grentx_tabplimage);
                ...
                case 2:
                    ...
                    break;
                case 3:
                    shoucAdapter = new ShoucGanmeAdapter(LoginCGActivity.this, mCollections);
                    shoucangGrid.setAdapter(shoucAdapter);
                    UtilsTools.getInstance(LoginCGActivity.this).setListViewHeightBasedOnChildren(shoucangGrid);
                    shoucangGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        @Override
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            Intent intent = new Intent(LoginCGActivity.this, GameXqingActivity.class);
                ...
                case 4:
                    ...
                    UtilsTools.getInstance(LoginCGActivity.this).setListViewHeightBasedOnChildren(wanguoGrid);
                    ...
                    break;
                case 5:
                    grenPLListAdapter = new GrenPLListAdapter(LoginCGActivity.this, tgrComments);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSP = SPrefUtils.getInstance(LoginCGActivity.this);
        titleLimage = (ImageView) this.findViewById(R.id.title_logincgxq).findViewById(R.id.titleLimage);
        titleRgeisicon = (ImageView) this.findViewById(R.id.title_logincgxq).findViewById(R.id.titleRgeisicon);
        titleContText = (TextView) this.findViewById(R.id.title_logincgxq).findViewById(R.id.titleContText);
        ...
        logincg_tad = (TabLayout) this.findViewById(R.id.logincg_tad);
        scroll_view = (MyScrollView) this.findViewById(R.id.scroll_view);
        logincg_pager = (ViewPager) this.findViewById(R.id.logincg_pager);
        grenShezhi = (LinearLayout) this.findViewById(R.id.grenShezhi);
        grenZhangdan = (LinearLayout) this.findViewById(R.id.grenZhangdan);
        grenDhuan = (LinearLayout) this.findViewById(R.id.grenDhuan);
        grenXGZL = (ImageView) this.findViewById(R.id.grenXGZL);
        sqfqi = (ImageView) this.findViewById(R.id.sqfqi);
        weidl = (LinearLayout) this.findViewById(R.id.weidl);
        weidl.setOnClickListener(this);
        grentx_tabplimage = (CircleImageView) this.findViewById(R.id.grentx_tabplimage);
        userid = (TextView) this.findViewById(R.id.userid);
        usernamems = (TextView) this.findViewById(R.id.usernamems);

        gerendianz = (TextView) this.findViewById(R.id.gerendianz);
        fensinum = (TextView) this.findViewById(R.id.fensinum);
        guanzhunum = (TextView) this.findViewById(R.id.guanzhunum);
    ...
    public void onResume() {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            getfindUserRelNumer();
            view_01 = LoginCGActivity.this.getLayoutInflater().inflate(R.layout.wanq_gren_szhiyx_layout, null);
            view_02 = LoginCGActivity.this.getLayoutInflater().inflate(R.layout.wanq_gren_szhipl_layout, null);
            ...
            adapter = new GrenFragmentPagerAdapter(LoginCGActivity.this);
            ...
            linearLayout.setDividerDrawable(ContextCompat.getDrawable(LoginCGActivity.this,
        ...
        switch (v.getId()) {
            case R.id.wanguo:
                if (TextUtils.isEmpty(mSP.getString(mSP.USER_ID, ""))) {
                    UtilsTools.getInstance(LoginCGActivity.this).startClass(GrenActivity.class);
                } else {
            ...
            case R.id.grenShezhi:
                if (TextUtils.isEmpty(mSP.getString(mSP.USER_ID, ""))) {
                    ...
                    UtilsTools.getInstance(LoginCGActivity.this).startClass(SZHIActivity.class);
                break;
            case R.id.grenZhangdan:
                if (TextUtils.isEmpty(mSP.getString(mSP.USER_ID, ""))) {
                    UtilsTools.getInstance(LoginCGActivity.this).startClass(GrenActivity.class);
                } else
                    UtilsTools.getInstance(LoginCGActivity.this).startClass(GrenZDanActivity.class);
            ...
            case R.id.grenDhuan:
                if (TextUtils.isEmpty(mSP.getString(mSP.USER_ID, ""))) {
                    ...
                    UtilsTools.getInstance(LoginCGActivity.this).startClass(GrenDhuanActivity.class);
                break;
            case R.id.grenXGZL:
                if (TextUtils.isEmpty(mSP.getString(mSP.USER_ID, ""))) {
                    UtilsTools.getInstance(LoginCGActivity.this).startClass(GrenActivity.class);
                } else
                    UtilsTools.getInstance(LoginCGActivity.this).startClass(GrenXGActivity.class);
                break;
            case R.id.sqfqi:
                if (TextUtils.isEmpty(mSP.getString(mSP.USER_ID, ""))) {
                    UtilsTools.getInstance(LoginCGActivity.this).startClass(GrenActivity.class);
    ...
    private void getUserDatas() {
        try {
            RequestManager.getInstance(LoginCGActivity.this).httpPost(Config.getfindUserData, ParaTran.getInstance(LoginCGActivity.this).
                ...
                public void onReqSuccess(String result) {
                    try {
                        ...
                        SPrefUtils mSP = SPrefUtils.getInstance(LoginCGActivity.this);
    ...
    private void getfindUserRelNumer() {
        try {
            RequestManager.getInstance(LoginCGActivity.this).httpPost(Config.getfindUserRelNumer, ParaTran.getInstance(LoginCGActivity.this).
    ...
    private void getfindUserAuth() {
        try {
            RequestManager.getInstance(LoginCGActivity.this).httpPost(Config.getfindUserAuth, ParaTran.getInstance(LoginCGActivity.this).
                ...
                public void onReqSuccess(String result) {
                    try {
                        ...
                        int resultType = jsonObject.getInt("result");
                        if (resultType == 1) {
                            UtilsTools.getInstance(LoginCGActivity.this).startClass(GrenSMRZActivity.class);
                            return;
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    private void getCollectionlist(int pageNum, int pageSize) {
        try {
            RequestManager.getInstance(LoginCGActivity.this).httpPost(Config.getUserCollectionlist, ParaTran.getInstance(LoginCGActivity.this).
    ...
    private void getwanguolist(int pageNum, int pageSize) {
        try {
            RequestManager.getInstance(LoginCGActivity.this).httpPost(Config.getUserwanguolist, ParaTran.getInstance(LoginCGActivity.this).
                    setUserCollectionlist(pageNum, pageSize), new ReqCallBack() {
                @Override
                public void onReqSuccess(String result) {
                    try {
    ...
    private void getPLList() {
        try {
            RequestManager.getInstance(LoginCGActivity.this).httpPost(Config.getusersCommentlist,
                    ParaTran.getInstance(LoginCGActivity.this).setUComment(), new ReqCallBack() {
                        @Override
                        public void onReqSuccess(String result) {
