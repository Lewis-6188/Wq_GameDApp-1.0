...
public class FxHorizontalScrollView extends HorizontalScrollView implements
    ...
    public FxHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 获得屏幕宽度
...
//			mContainer = (LinearLayout) getChildAt(0);
     ...
     * @param mAdapter
     */
    public void initDatas(FXHorizontalScrollViewAdapter mAdapter, int size) {
