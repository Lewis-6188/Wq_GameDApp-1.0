...
public class FXHorizontalScrollViewAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<Tbiqian> mDatas;

    public FXHorizontalScrollViewAdapter(Context context, List<Tbiqian> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.wanq_fxian_index_gallery_item, parent, false);
